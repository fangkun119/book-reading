...
运用上面的方法挑选基金，例如在2017-09-30日，可以看到如下基金（注：过去不代表现在、现在不代表未来）
...
>
> 1. 指数通常估值回归的特性，估值低时未来收益有确定性（时间可能会长、但总会回归）
> 2. 要等到估值足够低、尤其不要在熊市初期的急跌中接飞刀
...
>
> 例如：目标是4个月每月增加基金市值1000元，一共存下1000元
>
...
基金定投适用于**指数**这样风格转换的品种（低谷时春种涨起来时秋收）

> 反之一些优秀的主动选股类基金总是上涨的、就不适合定投，适合直接买

不要用基金定投的方式投资股票

> 指数低估后估值回归的确定性更强，而个股不确定更强有可能出现趋势性长期下跌，例如中石化

定投是止盈不止损、随着下跌持续买入，越低买入份数越多平均成本越低

> 备注：
>
> * 其实这也是估值/货币周期/形态走势的把握来给自己底气；也是对心态的考验
> * 不是每个人都能立刻适应，即便是定投这样的比较简单的策略，很多人也仍然需要一段时间的练习。所以再次提醒风险、建议多学多练（用小钱），而不是急着使用
...
> 备注：之前看过一些，大致是用几种不同波动幅度的股债配置外加货币基金，构建出几个组合
>
> * 波动低的组合：收益低、但不容易产生浮亏，中期短期要用可以取出
> * 波动高的组合：长期收益高，但是中途下跌幅度也大，要持有较长时间
>
> 我在这里略过了，有两个原因：（1）本金要求高、没那么多钱（2）先练本领、本领不到位也不敢折腾那么多的钱
...
> (3) 需要坚守能力边界，管住手
>
> 最重要的是只用小钱练手，只有当那些方法已经消化掌握后，才会用在比较大的资金上。具备稳健收益能力后，会有强大的持续复利效应。
